...
<div style="background:#fff8db; color:#333; border-left:6px solid #1e6c93; padding:1em 1.25em; margin:1.5em 0; border-radius:0.5em; box-shadow:0 2px 8px rgba(30,108,147,0.07); display:flex; align-items:flex-start; gap:0.75em;">
  ...
  <span>
    Workshop attendance is only possible for registered Indaba attendees. That is, only those accepted to attend the DLI 2025 can physically attend the workshop. If you were not accepted, you could still join us virtually. <a href="https://deeplearningindaba.com/2025/" style="color:#1e6c93; text-decoration:underline;">Learn more here</a>.
  </span>
</div>
